...
export const createFilterEpochsEpic = (fromState: any => any) => (
...
export const createToggleEpochEpic = (fromState: any => any) => (
  action$: Observable<any>,
  state$: Observable<any>
): Observable<Action> => {
  return action$.pipe(
...
export const createActiveEpochEpic = (fromState: any => any) => (
  action$: Observable<any>,
  state$: Observable<any>
): Observable<Action> => {
  return action$.pipe(
