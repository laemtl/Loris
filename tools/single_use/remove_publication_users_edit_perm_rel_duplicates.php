...
to make sure the patch '2020-01-07-publication_users_edit_perm_rel_pk.sql' will execute successfully.\n\n";
...
echo "\nYou can now apply the patch '2020-01-07-publication_users_edit_perm_rel_pk.sql'\n";
